        ...
        {items.map((repo) => (
          ...
          >
            ...
            <div>
              ...
              >
                <option value="JAMARQ">JAMARQ</option>
                <option value="TENRA">TENRA</option>
              </select>
            </div>
            <div className="flex flex-col gap-2 text-xs text-slate-400">
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={(event) => updateItem(repo.id, { triggerDrafts: event.target.checked })}
                  className="h-4 w-4 rounded border-slate-600 bg-slate-900"
                />
                Trigger drafts
              </label>
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={(event) => updateItem(repo.id, { triggerSchedules: event.target.checked })}
                  className="h-4 w-4 rounded border-slate-600 bg-slate-900"
                />
                Trigger schedules
              </label>
            ...
            <div className="flex flex-col gap-2 text-xs text-slate-400">
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={(event) => updateItem(repo.id, { triggerTasks: event.target.checked })}
                  className="h-4 w-4 rounded border-slate-600 bg-slate-900"
                />
                Trigger tasks
              </label>
